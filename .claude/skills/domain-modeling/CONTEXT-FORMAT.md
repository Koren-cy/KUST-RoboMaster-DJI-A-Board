...
**Multiple contexts:** A `CONTEXT-MAP.md` at the repo root lists the contexts, where they live, and how they relate. The skill infers which structure applies and creates files lazily.

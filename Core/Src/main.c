...
int main(void)
{
  ...
  PID_Init(&FR_M3508_PID, 3.0f, 0.0f, 5.0f, 5200.0f, 0.0f);
  PID_Init(&FL_M3508_PID, 3.0f, 0.0f, 5.0f, 5200.0f, 0.0f);
  PID_Init(&RR_M3508_PID, 3.0f, 0.0f, 5.0f, 5200.0f, 0.0f);
  PID_Init(&RL_M3508_PID, 3.0f, 0.0f, 5.0f, 5200.0f, 0.0f);

  DJI_Motor_Old_Init(&FR_GM6020, &user_can_1, 1, GM6020_old, Rotor_angle_old, 43.0f , 0.0f, 360.0f, 8000.0f, 0);
  DJI_Motor_Old_Init(&FL_GM6020, &user_can_1, 3, GM6020_old, Rotor_angle_old, 43.0f , 0.0f, 360.0f, 8000.0f, 0);
  DJI_Motor_Old_Init(&RR_GM6020, &user_can_1, 2, GM6020_old, Rotor_angle_old, 43.0f , 0.0f, 360.0f, 8000.0f, 0);
  DJI_Motor_Old_Init(&RL_GM6020, &user_can_1, 4, GM6020_old, Rotor_angle_old, 43.0f , 0.0f, 360.0f, 8000.0f, 0);
